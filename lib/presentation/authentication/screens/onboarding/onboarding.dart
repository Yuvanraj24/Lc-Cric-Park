    ...
    return Scaffold(
      body: Stack(children: [
        ...
        PageView(
            ...
            children:  [
          OnBoardingPage(image: AppImages.onBoardingImage1, title: AppTextStrings.onBoardingTitle1, subTitle: AppTextStrings.onBoardingSubTitle1),
          OnBoardingPage(image: AppImages.onBoardingImage2, title: AppTextStrings.onBoardingTitle2, subTitle: AppTextStrings.onBoardingSubTitle2),
          OnBoardingPage(image: AppImages.onBoardingImage3, title: AppTextStrings.onBoardingTitle3, subTitle: AppTextStrings.onBoardingSubTitle3),
        ]),
